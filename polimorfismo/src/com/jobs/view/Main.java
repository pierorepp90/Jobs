...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		...
		controller.createManagerEmployee("Pedro Employee", "Dirección molona 2", "665226666oooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooooo", 80.0);
